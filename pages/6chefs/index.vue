      ...
      <v-flex xs12 sm12>
        <div class="top-image-wrapper">
          ...
          <div class="top-image-inner-text">
            <p class="top-image-inner-header">6人の料理人と隻眼の少女</p>
            <p>「晩餐会」</p>
            <p>優秀な成績を収めれば料理人としての将来が約束され、</p>
            <p>結果を残せなければ日の目を見ることはほぼない</p>
            <p>という若い料理人にとっての関門。</p>
            <br />
            <p>今宵晩餐会に集まった料理人は6人。</p>
            <p>しかしそこに待ち受けていたのは・・・</p>
            <br />
            <p>喰うか喰われるか、料理するかされるか、</p>
            <p>料理人たちと協力したり、探索しながら</p>
            <p>晩餐会の裏に隠された秘密を暴く。</p>
            <p>ホラーアドベンチャー×ノベル ゲーム。</p>
          </div>
        </div>
      </v-flex>
      <GameHeader6chefs />
          ...
          <v-card style="width: 100%">
            ...
            <v-card-text>
              <iframe
                width="100%"
                height="315"
                src="https://www.youtube.com/embed/uj_5n0Fnhjw"
                frameborder="0"
...
.top-image-wrapper {
  ...
  align-items: center;
  background-image: url('/img/6chefs/title.png');
...
export default defineComponent({
  ...
  head() {
    const title = '6人の料理人と隻眼の少女'
    const description =
      'ホラーアクションアドベンチャーゲーム「6人の料理人と隻眼の少女」公式サイト'
    const url = '/6chefs'
    return VueHeaderHelper.generateHeadObject(title, description, url)
  },
  setup() {
    const table = [
      { key: 'タイトル', value: '6人の料理人と隻眼の少女' },
